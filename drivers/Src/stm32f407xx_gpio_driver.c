 ...
 * @fn			- GPIO_Init
 *
 * @brief		- This function initialize peripheral given GPIO port
 *
 * @param[in]	- gpio handle ty
 *
 * @return 		- None
 *
 * @Note 		- None
...
void GPIO_Init(GPIO_Handle_t *pGPIOHandle) {
	...
	if (pGPIOHandle->GPIO_PinConfig.GPIO_PinMode <= GPIO_MODE_ANALOG) {
		...
		if (pGPIOHandle->GPIO_PinConfig.GPIO_PinMode == GPIO_MODE__FT) {
			// configure the FTSR
		...
		} else if (pGPIOHandle->GPIO_PinConfig.GPIO_PinMode == GPIO_MODE__RT) {
			// configure the RTSR
		...
		} else if (pGPIOHandle->GPIO_PinConfig.GPIO_PinMode == GPIO_MODE__RFT) {
 ...
 *
 * @brief		- This function read data from given GPIO port
 *
 * @param[in]	- Base address of gpio peripheral
 * @param[in]	- Pin number
 *
